(ns query.gentablecolumns
  (:require [clojure.java.jdbc :as jdbc]
            [clojure.java.io :as io])
  (:use query.utils))

(def ^:dynamic ^:private file-name)
(def ^:private file-name-default "entities.clj")
(def ^:private nsname-default "entities")
(def ^:private file-path "src/db/")
(def ^:private table-prefix "table-")
